...
- Data visualization using histograms, boxplots, and heatmaps
## How to run
Clone the repository:
git clone <https://github.com/ashmitsapra-VCU/A-1--EDA>  
Place the dataset (A1_12_Sapra_Data.csv) in the project folder.
Open and run the Jupyter Notebook:A1_12_Sapra.ipynb
...
#### This project demonstrates how data auditing and exploratory data analysis can be performed and used to understand the data in a better way, visualizations and support decision making in future
